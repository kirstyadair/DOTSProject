...
public class SpawnerAuthoringComponent : MonoBehaviour, IDeclareReferencedPrefabs, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new Spawner
        {
            ...
            lineBombSpawnerPrefab = entities[8],
            lineBombSpawnerPrefabChances = chances[8],
            crossBombSpawnerPrefab = entities[9],
            crossBombSpawnerPrefabChances = chances[9],
            areaBombSpawnerPrefab = entities[10],
            areaBombSpawnerPrefabChances = chances[10],
